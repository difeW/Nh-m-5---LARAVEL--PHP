...
<div class="product-details">
            ...
            <a class="right item-control" href="#similar-product" data-slide="next">
                ...
                <input type="hidden" value="{{$value->product_price}}"
                    ...
                    <input name="qty" type="number" data-validation="number"
                        data-validation-allowing="range [1; {{$value->product_quantity}}]"
                        data-validation-error-msg="Số lượng vượt số lượng tồn kho."
        ...
        <div style="float: right;">
            ...
            <a class><img src="images/product-details/share.png" class="share img-responsive" alt=""/>Thêm vào giỏ hàng</a>	
		</div>
		...
		<div class="tab-content">
			...
			<div class="tab-pane fade" id="reviews" >
				<div class="col-sm-12">
					...
					<p>
						Chân thành cảm ơn quý khách đã mua sản phẩm từ MuseTech, mọi đánh giá của quý khách sẽ giúp cho thương hiệu 
